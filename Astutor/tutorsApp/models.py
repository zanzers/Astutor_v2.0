...
class Account(models.Model):
    ...
    login = models.ForeignKey('LoginDetails', models.DO_NOTHING, db_column='login_ID')  # Field name made lowercase.
    register = models.ForeignKey('Register', models.DO_NOTHING, db_column='register_ID')  # Field name made lowercase.
    type = models.ForeignKey('AccountType', models.DO_NOTHING, db_column='type_ID')  # Field name made lowercase.
...
class Register(models.Model):
    register_id = models.AutoField(db_column='register_ID', primary_key=True)  # Field name made lowercase.
